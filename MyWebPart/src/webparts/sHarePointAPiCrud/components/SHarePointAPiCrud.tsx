...
import type { ISHarePointAPiCrudProps } from './ISHarePointAPiCrudProps';
...
const SHarePointAPiCrud: React.FC<ISHarePointAPiCrudProps> = (props:ISHarePointAPiCrudProps) => {
...
export default SHarePointAPiCrud;